...
It's a foraging app, to help people make the most of publicly available resources. It's such a shame when fruit and other edible treasures go to waste because no one knows where to find them or bothers to collect them. The app will allow users to see resources on the map and add pins when they find new foraging locations. It's still in development. Watch this space!  
